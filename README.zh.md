...
│   ├── narration_stage.jsx  # 解说驱动动画 Stage
│   ├── showcases/           # 24 个预制样例（8 场景 × 3 风格）
│   ├── sfx/                 # 37 个预制音效资源
│   └── bgm-*.mp3            # 6 首场景化背景音乐
├── references/              # 按任务深入读的子文档
│   ├── workflow.md          # 工作流：从接到任务到交付
│   ├── design-styles.md     # 20 种设计哲学详细库
│   ├── design-context.md    # 设计上下文 fallback 策略
│   ├── content-guidelines.md # 反 AI slop 内容规范
│   ├── animation-pitfalls.md # 动画踩坑与规则
│   ├── animations.md        # 动画 API 参考
│   ├── animation-best-practices.md # 叙事运动设计
│   ├── slide-decks.md       # HTML 幻灯片制作规范
│   ├── editable-pptx.md     # HTML→可编辑 PPTX 约束
│   ├── critique-guide.md    # 5 维度设计评审
│   ├── video-export.md      # HTML→MP4/GIF 导出
│   ├── audio-design-rules.md # SFX+BGM 双轨制规则
│   ├── sfx-library.md       # 37 个预制音效索引
│   ├── voiceover-pipeline.md # 长概念视频解说驱动流程
│   ├── launch-film-director-notes.md # Launch Film 工作流
│   ├── multi-perspective-parallel-case-study.md # 多视角并行实验
│   ├── cinematic-patterns.md # Gallery Ripple + Multi-Focus 模式
│   ├── hero-animation-case-study.md # Hero 动画实战案例
│   ├── apple-gallery-showcase.md # Apple 画廊展示风格
│   ├── react-setup.md       # React+Babel 项目 setup
│   ├── tweaks-system.md     # Tweaks 实时调参
...
每个能力的详细文档，深入读对应 references 即可：

| 主题 | 文件 |
|------|------|
| 工作流：从接到任务到交付 | [references/workflow.md](references/workflow.md) |
| 20 种设计哲学风格库 | [references/design-styles.md](references/design-styles.md) |
| 设计上下文 fallback 策略 | [references/design-context.md](references/design-context.md) |
| 反 AI slop 内容规范 | [references/content-guidelines.md](references/content-guidelines.md) |
| 动画踩坑与规则 | [references/animation-pitfalls.md](references/animation-pitfalls.md) |
| 动画 API 参考 | [references/animations.md](references/animations.md) |
| 叙事运动设计 | [references/animation-best-practices.md](references/animation-best-practices.md) |
| HTML 幻灯片制作规范 | [references/slide-decks.md](references/slide-decks.md) |
| 可编辑 PPTX 约束 | [references/editable-pptx.md](references/editable-pptx.md) |
| 5 维度设计评审 | [references/critique-guide.md](references/critique-guide.md) |
| 视频导出 MP4/GIF | [references/video-export.md](references/video-export.md) |
| SFX + BGM 音频规则 | [references/audio-design-rules.md](references/audio-design-rules.md) |
| 37 个预制音效索引 | [references/sfx-library.md](references/sfx-library.md) |
| 解说驱动动画 pipeline | [references/voiceover-pipeline.md](references/voiceover-pipeline.md) |
| Launch Film 工作流 | [references/launch-film-director-notes.md](references/launch-film-director-notes.md) |
| 多视角并行实验 | [references/multi-perspective-parallel-case-study.md](references/multi-perspective-parallel-case-study.md) |
| Gallery Ripple 模式 | [references/cinematic-patterns.md](references/cinematic-patterns.md) |
| Hero 动画实战案例 | [references/hero-animation-case-study.md](references/hero-animation-case-study.md) |
| Apple 画廊展示风格 | [references/apple-gallery-showcase.md](references/apple-gallery-showcase.md) |
| React + Babel 项目 setup | [references/react-setup.md](references/react-setup.md) |
| Tweaks 实时调参 | [references/tweaks-system.md](references/tweaks-system.md) |
| 按输出类型查场景模板 | [references/scene-templates.md](references/scene-templates.md) |
| 输出验证流程 | [references/verification.md](references/verification.md) |
